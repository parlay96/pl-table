import { getPropByPath } from 'pl-table/src/utils/util';
  ...
  selection: {
    renderHeader: function(h, { store }) {
      return <el-checkbox
        ...
        indeterminate={ store.states.useVirtual && store.states.bigDataCheckbox ? store.states.selection.length > 0 && !store.states.newisAllSelected : store.states.selection.length > 0 && !this.isAllSelected }
