...
/* harmony import */ var pl_table_src_utils_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var pl_table_src_utils_util__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(pl_table_src_utils_util__WEBPACK_IMPORTED_MODULE_0__);
  ...
  var getKey = sortMethod ? null : function (value, index) {
    if (sortBy) {
      ...
      return sortBy.map(function (by) {
        if (typeof by === 'string') {
          return Object(pl_table_src_utils_util__WEBPACK_IMPORTED_MODULE_0__["getValueByPath"])(value, by);
        } else {
    ...
    return [isObject(value) ? Object(pl_table_src_utils_util__WEBPACK_IMPORTED_MODULE_0__["getValueByPath"])(value, sortKey) : value];
  };
...
var packages_checkbox = __webpack_require__(6);

// EXTERNAL MODULE: external "throttle-debounce"
var external_throttle_debounce_ = __webpack_require__(17);

// EXTERNAL MODULE: external "resize-observer-polyfill"
var external_resize_observer_polyfill_ = __webpack_require__(12);
...
var external_normalize_wheel_ = __webpack_require__(19);
  ...
  methods: {
    ...
    isSelected: function isSelected(row) {
      ...
      if (this.states.useVirtual && this.states.bigDataCheckbox) {
        ...
        var _states$selection2 = this.states.selection,
            _selection = _states$selection2 === undefined ? [] : _states$selection2;

        return _selection.indexOf(row) > -1;
      }
    },
    ...
    toggleRowSelection: function toggleRowSelection(row, selected) {
      ...
      var changed = Object(util["m" /* toggleRowStatus */])(this.states.selection, row, selected, this);
      if (changed) {
...
/* harmony default export */ var table_body = ({
  ...
  components: {
    ElCheckbox: packages_checkbox["a" /* default */],
...
var mixins_locale_ = __webpack_require__(8);
...
var scrollbar_width_ = __webpack_require__(20);
...
/* harmony default export */ var table_mixins = ({
  ...
  methods: {
    ...
    // 表体滚动到什么位置
    pagingScrollTop: function pagingScrollTop(top) {
      var tableBodyWrapper = this.$el.querySelector('.el-table__body-wrapper');
      if (tableBodyWrapper) {
...
var external_vuedraggable_ = __webpack_require__(21);
...
var pl_table_column_ = __webpack_require__(22);
...
var migrating_ = __webpack_require__(24);
...
var shared_ = __webpack_require__(15);
...
var scroll_into_view_ = __webpack_require__(25);
        ...
        setHeight: function setHeight() {
            ...
            if (this.$refs.tableBox) {
                ...
                this.$nextTick(function () {
                    ...
                    // 随数据高度变化
                    if (_this7.heightChange) {
                        _this7.$nextTick(function () {
                            if (!_this7.$refs.singleTable) return;
                            if (!_this7.$refs.singleTable.$el.childNodes[0]) return;
                            _this7.$refs.singleTable.$el.childNodes.forEach(function (item) {
                                // 表体高
                                if (item.className && item.className.indexOf('el-table__body-wrapper') !== -1) {
                                    if (parseInt(item.style.height)) {
                                        if (item.children[0]) {
                                            // 表体高度如果大于，表体内容的高度，代表表格高度得减少
                                            var tablebodyH = parseInt(item.style.height) - item.children[0].offsetHeight;
                                            if (tablebodyH > 0) {
                                                // 获取表格宽度  判断是否出现滚动条
                                                if (item.children[0]) {
                                                    // 滚动条样式高度
                                                    var scrollBarHeight = item.offsetHeight - item.clientHeight;
                                                    if (scrollBarHeight && item.clientWidth < item.children[0].clientWidth) {
                                                        _this7.maxHeight = tableBox - myPagination - tablebodyH + scrollBarHeight;
                                                    } else {
                                                        _this7.maxHeight = tableBox - myPagination - tablebodyH;
                                                    }
                                                }
                                                // 如果没数据 就加上提示的高度
...
var plTable_component = Object(componentNormalizer["a" /* default */])(
...
/* harmony default export */ var pl_table = __webpack_exports__["default"] = (plTable);
