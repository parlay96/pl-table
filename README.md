...
# 进来pl-table的请注意看，这么大的问题你应该能看见，pl-table 不在更新维护,遇到问题请第一时间加群看是不是自己问题，如果是自己问题你就继续使用pl-table,如果是pl-table问题，那么请你不要使用pl-table用下面的umyui，再说三次。pl-table 不在更新维护,pl-table 不在更新维护,pl-table 不在更新维护！！！
